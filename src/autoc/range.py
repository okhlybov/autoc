...
class Forward(Input):
  ...
  def __setup__(self):
    ...
    self.description = f"""
      This iterator allows traversing the iterable container (@ref {getattr(self.iterable, 'name', self.iterable)}) in forward direction.
    """
...
class Backward(Input):
  ...
  def __setup__(self):
    ...
    self.description = f"""
      This iterator allows traversing the iterable container (@ref {getattr(self.iterable, 'name', self.iterable)}) in backward direction.
    """
...
class Bidirectional(Forward, Backward):
  ...
  def __setup__(self):
    ...
    self.description = f"""
      This iterator allows traversing the iterable container (@ref {getattr(self.iterable, 'name', self.iterable)}) in both (forward and backward) directions.
    """
