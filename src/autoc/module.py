...
class Header(EntityContainer, SmartRenderer):
  def __init__(self, module, *args, **kws):
    super().__init__(*args, **kws)
    self.module = module
    self._digest = None
  ...
  def stream(self):
    if self._stream is None:
      self._stream = StreamFile(self.file_name + "~")
    return self._stream
...
class Source(EntityContainer, SmartRenderer):
...
class Entity:
  ...
  def dependencies(self):
    if self._dependencies is None:
      self._dependencies = DependencySet(self)
