...
Note that this key must be explicitely set to either \C-side function name or \lstinline[language=Ruby]!nil! if one wants to have the respective functionality.
...
\emph{This is an optional function generated only when the key \lstinline[language=Ruby]!:compare! is specified explicitely.}
